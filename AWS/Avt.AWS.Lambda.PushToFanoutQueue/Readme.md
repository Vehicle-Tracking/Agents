...
Execute unit tests
```
    cd "AVT.AWS.Lambda.PushToFanoutQueue/test/AVT.AWS.Lambda.PushToFanoutQueue.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AVT.AWS.Lambda.PushToFanoutQueue/src/AVT.AWS.Lambda.PushToFanoutQueue"
